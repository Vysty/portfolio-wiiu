...
export default function AppTile({ label, icon, content, onOpen, bubblePos }: AppTileProps) {
  return (
    <motion.div
      ...
      className={`relative w-28 h-28 md:w-32 md:h-32 lg:w-44 lg:h-44 rounded-lg flex flex-col items-center justify-center cursor-pointer shadow-md border-6 md:border-8 lg:border-12 border-tilescolor/80 bg-tilescolor/40 backdrop-blur-sm hover:border-tileselected hover:bg-tileselected/20 hover:shadow-[0_0_20px_rgba(65,198,219,0.5)] transition-all duration-300`}
    >
