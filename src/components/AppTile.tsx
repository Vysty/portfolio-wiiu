...
export default function AppTile({ label, icon, content, onOpen, bubblePos }: AppTileProps) {
  return (
    <motion.div
      ...
      className={`relative w-24 h-24 md:w-32 md:h-32 lg:w-44 lg:h-44 rounded-lg flex flex-col items-center justify-center cursor-pointer shadow-md border-4 md:border-8 lg:border-12 border-tilescolor/80 bg-tilescolor/80 hover:border-tileselected hover:bg-tileselected transition-colors duration-500`}
    >
