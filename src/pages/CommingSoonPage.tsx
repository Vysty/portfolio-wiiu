...
export default function CommingSoonPage() {
    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-slate-900 to-gray-800 flex flex-col items-center justify-center text-white px-4">
            <h1 className="text-1xl md:text-4xl font-semibold mb-2 tracking-wide">
                Thomas Marie--Duval
            </h1>
            ...
            <h2
                ...
                style={{
                    whiteSpace: 'nowrap',
                    animation:
                        'typing 3s steps(25, end), blink 1.5s step-end infinite',
                }}
            >
            ...
            <div className="flex justify-center gap-5 my-3">
                ...
                <a
                    href="mailto:contact@thomas-marie-duval.fr"
                    className="group flex flex-col justify-center items-center w-16"
                >
                    <svg
