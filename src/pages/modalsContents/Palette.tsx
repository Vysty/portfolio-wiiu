      ...
      <div className="flex flex-col overflow-y-auto h-full w-full p-4 space-y-4 gap-5">
        <div className="grid w-full grid-cols-[9fr_11fr] gap-10 items-start">
          <div className={"flex flex-col gap-4 text-justify text-xl min-w-0"}>
            ...
            <p>
              ...
              listant les adresses exactes dans l'entrepôt, les noms d'articles et les quantités requises
              pour chaque commande. Pour faciliter l'arrangement des colis sur le support, l'application intègre un
              moteur de rendu 3D modélisant le support en cours de montage. Ce module affiche visuellement l'emplacement
              optimal et le plus stable pour le placement du prochain colis.
            </p>
        ...
        <div className={"flex flex-col gap-8"}>
          ...
          <div className={"flex justify-around items-start"}>
            <Badge title={"FrontEnd"} content={"React, Tailwind CSS, Three.js, Web Speech API pour le STT et TTS natifs"}>
