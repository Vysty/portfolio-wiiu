...
// Contenu de la modale pour le projet "Rust Garden"
      ...
      <div className="flex flex-col overflow-y-auto h-full w-full p-2 md:p-4 space-y-4 gap-5">
        <div className="grid w-full grid-cols-1 lg:grid-cols-[9fr_11fr] gap-6 lg:gap-10 items-start">
          ...
          <div className={'flex flex-col gap-4 text-justify text-base md:text-xl min-w-0 order-2 lg:order-1'}>
            ...
            <p>
              Ce projet illustre la conception d'une architecture logicielle distribuée et robuste, allant de la capture
              de données par des capteurs connectés à un Arduino, jusqu'à leur restitution via une interface
              utilisateur, avec l'écosystème Rust au cœur de la stack.
            </p>

            <p>
              Cette interface permet également l'automatisation de commandes telles que l'entretien du jardin
              manuellement ou bien automatisé en fonction des besoins de la plante.
            </p>
          ...
          {/* Section Image avec fonction d'agrandissement */}
        ...
        {/* Section Stack Technique avec des Badges explicatifs */}
